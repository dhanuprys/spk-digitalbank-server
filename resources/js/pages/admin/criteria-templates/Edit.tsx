...
export default function Edit({ criteriaTemplate }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        // Level 2 Criteria Group 1 Values
        l2_cg1_a_value: criteriaTemplate.l2_cg1_a_value?.toString() || '0',
        l2_cg1_b_value: criteriaTemplate.l2_cg1_b_value?.toString() || '0',
        l2_cg1_c_value: criteriaTemplate.l2_cg1_c_value?.toString() || '0',
        l2_cg1_d_value: criteriaTemplate.l2_cg1_d_value?.toString() || '0',
        l2_cg1_e_value: criteriaTemplate.l2_cg1_e_value?.toString() || '0',
        ...
        // Level 2 Criteria Group 2 Values
        l2_cg2_a_value: criteriaTemplate.l2_cg2_a_value?.toString() || '0',
        l2_cg2_b_value: criteriaTemplate.l2_cg2_b_value?.toString() || '0',
        l2_cg2_c_value: criteriaTemplate.l2_cg2_c_value?.toString() || '0',
        l2_cg2_d_value: criteriaTemplate.l2_cg2_d_value?.toString() || '0',

        // Level 2 Criteria Group 2 Max Flags
        l2_cg2_a_max: criteriaTemplate.l2_cg2_a_max,
        l2_cg2_b_max: criteriaTemplate.l2_cg2_b_max,
        l2_cg2_c_max: criteriaTemplate.l2_cg2_c_max,
        l2_cg2_d_max: criteriaTemplate.l2_cg2_d_max,

        // Level 2 Criteria Group 3 Values
        l2_cg3_a_value: criteriaTemplate.l2_cg3_a_value?.toString() || '0',
        l2_cg3_b_value: criteriaTemplate.l2_cg3_b_value?.toString() || '0',
        l2_cg3_c_value: criteriaTemplate.l2_cg3_c_value?.toString() || '0',
        l2_cg3_d_value: criteriaTemplate.l2_cg3_d_value?.toString() || '0',
        l2_cg3_e_value: criteriaTemplate.l2_cg3_e_value?.toString() || '0',
        ...
        // Level 1 Criteria Group 1 Values
        l1_cg1_a_value: criteriaTemplate.l1_cg1_a_value?.toString() || '0',
        l1_cg1_b_value: criteriaTemplate.l1_cg1_b_value?.toString() || '0',
        l1_cg1_c_value: criteriaTemplate.l1_cg1_c_value?.toString() || '0',
    ...
    return (
        <AdminLayout title="Edit Template Kriteria" description="Edit template kriteria">
            <Head title="Edit Template Kriteria" />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Edit template kriteria penilaian</p>
                        </div>
                    </div>
                </div>
