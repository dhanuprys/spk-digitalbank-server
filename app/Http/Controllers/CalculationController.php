...
class CalculationController extends Controller
{
    ...
    public function calculate(Request $request)
    {
        $request->validate([
            ...
            // Max flags for Level 2 Criteria Group 1
            ...
            // Max flags for Level 1 Criteria Group 1
        ...
        $criteria = new UserCriteria(
            ...
            l2_cg2_c_value: $request->l2_cg2_c_value,
            l2_cg2_d_value: $request->l2_cg2_d_value,
            ...
            l2_cg2_c_max: $request->l2_cg2_c_max,
            l2_cg2_d_max: $request->l2_cg2_d_max,
    ...
    public function calculateTemplate(Request $request)
    {
        ...
        $criteria = new UserCriteria(
            ...
            l2_cg2_c_value: $template->l2_cg2_c_value,
            l2_cg2_d_value: $template->l2_cg2_d_value,
            ...
            l2_cg2_c_max: $template->l2_cg2_c_max,
            l2_cg2_d_max: $template->l2_cg2_d_max,
